...
namespace RepasoS.Acudiente.WebForm
{
    public partial class Consultar : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        DataSet DatosNotas2 = ObjNota.ConsultarNota(int.Parse(DropDownList3.Text), "Primer Semestre", "Primer Corte", DatosConsultados.Rows[0]["Asignatura"].ToString());
                        ...
                        else
                        {
                            ...
                            try
                            {
                                ...
                                DataSet DatosNotas3 = ObjNota.ConsultarNota(int.Parse(DropDownList3.Text), "Primer Semestre", "Segundo Corte", DatosConsultados.Rows[0]["Asignatura"].ToString());
                                ...
                                else
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        DataSet DatosNotas4 = ObjNota.ConsultarNota(int.Parse(DropDownList3.Text), "Segundo Semestre", "Primer Corte", DatosConsultados.Rows[0]["Asignatura"].ToString());
                                        ...
                                        else
                                        {
                                            ...
                                            try
                                            {
                                                ...
                                                DataSet DatosNotas5 = ObjNota.ConsultarNota(int.Parse(DropDownList3.Text), "Segundo Semestre", "Segundo Corte", DatosConsultados.Rows[0]["Asignatura"].ToString());
                ...
                else
                {
                    ...
                    for (int i = 0; i <= numregistros - 1; i++)
                    {
                        ...
                        try
                        {
                            ...
                            DataSet DatosNotas2 = ObjNota.ConsultarNota(int.Parse(DropDownList3.Text), "Primer Semestre", "Primer Corte", DatosConsultados.Rows[i]["Asignatura"].ToString());
                            ...
                            else
                            {
                                ...
                                try
                                {
                                    ...
                                    DataSet DatosNotas3 = ObjNota.ConsultarNota(int.Parse(DropDownList3.Text), "Primer Semestre", "Segundo Corte", DatosConsultados.Rows[i]["Asignatura"].ToString());
                                    ...
                                    else
                                    {
                                        ...
                                        try
                                        {
                                            ...
                                            DataSet DatosNotas4 = ObjNota.ConsultarNota(int.Parse(DropDownList3.Text), "Segundo Semestre", "Primer Corte", DatosConsultados.Rows[i]["Asignatura"].ToString());
                                            ...
                                            else
                                            {
                                                ...
                                                try
                                                {
                                                    ...
                                                    DataSet DatosNotas5 = ObjNota.ConsultarNota(int.Parse(DropDownList3.Text), "Segundo Semestre", "Segundo Corte", DatosConsultados.Rows[i]["Asignatura"].ToString());
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                DataSet DatosEstudiante = ObjEstudiante.ConsultarEstudianteTodos3(int.Parse(DropDownList3.Text));
                    ...
                    for (int i = 0; i <= numregistros - 1; i++)
                    {
                        ...
                        try
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    DataSet DatosNotas2 = ObjNota.ConsultarNota(int.Parse(DropDownList3.Text), "Primer Semestre", "Primer Corte", DatosConsultados10.Rows[o]["Asignatura"].ToString());
                                ...
                                {
                                    DataSet DatosNotas3 = ObjNota.ConsultarNota(int.Parse(DropDownList3.Text), "Primer Semestre", "Segundo Corte", DatosConsultados10.Rows[o1]["Asignatura"].ToString());
                                ...
                                {
                                    DataSet DatosNotas4 = ObjNota.ConsultarNota(int.Parse(DropDownList3.Text), "Segundo Semestre", "Primer Corte", DatosConsultados10.Rows[o2]["Asignatura"].ToString());
                                ...
                                {
                                    DataSet DatosNotas5 = ObjNota.ConsultarNota(int.Parse(DropDownList3.Text), "Segundo Semestre", "Segundo Corte", DatosConsultados10.Rows[o4]["Asignatura"].ToString());
