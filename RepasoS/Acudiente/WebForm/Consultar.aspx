<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Consultar.aspx.cs" Inherits="RepasoS.Acudiente.WebForm.Consultar" %>
<!DOCTYPE html>
...
<body bgcolor="#e8e8e8">
    ...
    <center>
        ...
        Seleccione el estudiante que desea consultar<br />
            <br />
            <br />
         Usuario:
            <asp:DropDownList ID="DropDownList3" runat="server"  DataSourceID="SqlDataSource3" DataTextField="IdentificacionEst" DataValueField="IdentificacionEst">
                <asp:ListItem>No tiene estudiantes asignados</asp:ListItem>
            </asp:DropDownList>
            <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="Data Source=DESKTOP-GFI9B2I;Initial Catalog=NotasEOH2;Integrated Security=True" SelectCommand="SELECT [IdentificacionEst] FROM [Estudiante] WHERE ([IdentificacionAcu] = @IdentificacionAcu)">
                <SelectParameters>
