...
namespace RepasoS.Estudiante.WebForm
{
    public partial class Consultar : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                DataSet DatosAsignatura = ObjAsignatura.ConsultarAsignaturaTodos2(DropDownList1.Text);
                ...
                if (numregistros == 0)
                {
                    MessageBox.alert("No hay asignaturas");
                }
                else
                {
                        ...
                        objTemporal.Text = DatosConsultados.Rows[0]["Asignatura"].ToString();
                        ...
                        try
                        {
                            ...
                            DataSet DatosNotas2 = ObjNota.ConsultarNota(int.Parse(Session["IdentificacionEst"].ToString()), "Primer Semestre", "Primer Corte", DatosConsultados.Rows[0]["Asignatura"].ToString());
                            ...
                            else
                            {
                                ...
                                try
                                {
                                    ...
                                    DataSet DatosNotas3 = ObjNota.ConsultarNota(int.Parse(Session["IdentificacionEst"].ToString()), "Primer Semestre", "Segundo Corte", DatosConsultados.Rows[0]["Asignatura"].ToString());
                                    ...
                                    else
                                    {
                                        ...
                                        try
                                        {
                                            ...
                                            DataSet DatosNotas4 = ObjNota.ConsultarNota(int.Parse(Session["IdentificacionEst"].ToString()), "Segundo Semestre", "Primer Corte", DatosConsultados.Rows[0]["Asignatura"].ToString());
                                            ...
                                            else
                                            {
                                                ...
                                                try
                                                {
                                                    ...
                                                    DataSet DatosNotas5 = ObjNota.ConsultarNota(int.Parse(Session["IdentificacionEst"].ToString()), "Segundo Semestre", "Segundo Corte", DatosConsultados.Rows[0]["Asignatura"].ToString());
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                DataSet DatosAsignatura = ObjAsignatura.ConsultarAsignaturaAreaTodos2(DropDownList2.Text);
                ...
                if (numregistros == 0)
                {
                    MessageBox.alert("El area no tiene asignaturas");
                }
                else
                {
                    ...
                    for (int i = 0; i <= numregistros - 1; i++)
                    {
                        ...
                        try
                        {
                            ...
                            DataSet DatosNotas2 = ObjNota.ConsultarNota(int.Parse(Session["IdentificacionEst"].ToString()), "Primer Semestre", "Primer Corte", DatosConsultados.Rows[i]["Asignatura"].ToString());
                            ...
                            else
                            {
                                ...
                                try
                                {
                                    ...
                                    DataSet DatosNotas3 = ObjNota.ConsultarNota(int.Parse(Session["IdentificacionEst"].ToString()), "Primer Semestre", "Segundo Corte", DatosConsultados.Rows[i]["Asignatura"].ToString());
                                    ...
                                    else
                                    {
                                        ...
                                        try
                                        {
                                            ...
                                            DataSet DatosNotas4 = ObjNota.ConsultarNota(int.Parse(Session["IdentificacionEst"].ToString()), "Segundo Semestre", "Primer Corte", DatosConsultados.Rows[i]["Asignatura"].ToString());
                                            ...
                                            else
                                            {
                                                ...
                                                try
                                                {
                                                    ...
                                                    DataSet DatosNotas5 = ObjNota.ConsultarNota(int.Parse(Session["IdentificacionEst"].ToString()), "Segundo Semestre", "Segundo Corte", DatosConsultados.Rows[i]["Asignatura"].ToString());
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                DataSet DatosEstudiante = ObjEstudiante.ConsultarEstudianteTodos3(int.Parse(Session["IdentificacionEst"].ToString()));
            ...
            try
            {
                ...
                else
                {
                    ...
                    for (int i = 0; i <= numregistros - 1; i++)
                    {
                        ...
                        Div4.Controls.Add(new LiteralControl("<td>"));

                        Div4.Controls.Add(objTemporal);
                        ...
                        try
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    DataSet DatosNotas2 = ObjNota.ConsultarNota(int.Parse(Session["IdentificacionEst"].ToString()), "Primer Semestre", "Primer Corte", DatosConsultados10.Rows[o]["Asignatura"].ToString());
                                ...
                                Div4.Controls.Add(objTemporal2);
                                ...
                                {
                                    DataSet DatosNotas3 = ObjNota.ConsultarNota(int.Parse(Session["IdentificacionEst"].ToString()), "Primer Semestre", "Segundo Corte", DatosConsultados10.Rows[o1]["Asignatura"].ToString());
                                ...
                                Div4.Controls.Add(objTemporal3);
                                ...
                                {
                                    DataSet DatosNotas4 = ObjNota.ConsultarNota(int.Parse(Session["IdentificacionEst"].ToString()), "Segundo Semestre", "Primer Corte", DatosConsultados10.Rows[o2]["Asignatura"].ToString());
                                ...
                                Div4.Controls.Add(objTemporal4);
                                ...
                                {
                                    DataSet DatosNotas5 = ObjNota.ConsultarNota(int.Parse(Session["IdentificacionEst"].ToString()), "Segundo Semestre", "Segundo Corte", DatosConsultados10.Rows[o4]["Asignatura"].ToString());
                                ...
                                Div4.Controls.Add(objTemporal5);
                                ...
                                Div4.Controls.Add(objTemporal6);
                                ...
                                Div4.Controls.Add(objTemporal7);
                                ...
                                Div4.Controls.Add(objTemporal9);
                                ...
                                Div4.Controls.Add(objTemporal10);
                                ...
                                Div4.Controls.Add(objTemporal8);
                            ...
                            Div4.Controls.Add(new LiteralControl("</tr>"));
                        }
