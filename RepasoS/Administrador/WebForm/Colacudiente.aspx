<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Colacudiente.aspx.cs" Inherits="RepasoS.Administrador.WebForm.Colacudiente" %>
<!DOCTYPE html>
...
<body bgcolor="#e8e8e8">
    ...
    <div>
        <center>
            ...
            <br />
            <br />
            Ingresa el usuario del acudiente que deseas consultar<br />
            <br />
            <br />
            Usuario:
            ...
            <br />
            <br />
            <strong>- Ver todos los datos de todos los acudientes -</strong><br />
            <br />
            <br />
            <br />
