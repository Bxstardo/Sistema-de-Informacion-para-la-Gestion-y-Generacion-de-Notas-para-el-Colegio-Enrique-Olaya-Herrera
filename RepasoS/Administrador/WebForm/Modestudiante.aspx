<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Modestudiante.aspx.cs" Inherits="RepasoS.Administrador.WebForm.Modestudiante" %>
...
<body bgcolor="#e8e8e8">
    ...
    <div>
        <center>
            ...
            <br />
            <br />
            Ingresa el usuario del estudiante que deseas modificar o borrar<br />
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="Label4" runat="server"></asp:Label>
                                                          ...
                                                          <td> <br />
                        <asp:TextBox ID="TextBox3" runat="server" placeholder="Cafesalud,Medimas, etc..."  MaxLength="50" type="text" pattern="[aA-zZ ]+" CssClass="input"></asp:TextBox>
                    </td>
                    </tr>
                      ...
                      <tr>
                        ...
                        <td>
                            <asp:Label ID="Label7" runat="server"></asp:Label>
                                                               <td> <br />
                        <asp:TextBox ID="TextBox6" runat="server" placeholder="0000000000" MaxLength="13"  pattern="[0-9 ]+" CssClass="input"></asp:TextBox>
                    </td>
                                                                </td>
                        ...
                        <td>
                            <asp:Label ID="Label9" runat="server"></asp:Label>
                                                          ...
                                                          <td> <br />
                        <asp:TextBox ID="TextBox8" runat="server" MaxLength="50" cssClass="input" type="password"></asp:TextBox>
                    </td>
                    </tr>
                                                                                <tr>
                        <td>Acudiente:<br /> </td>
                        ...
                        <td>
                            <asp:Label ID="Label11" runat="server"></asp:Label>
                                                          ...
                                                          <td> <br />
                                               <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource1" DataTextField="Num_Curso" DataValueField="Num_Curso">
            ...
            <br />
            <br />
            <strong>- Ver todos los datos de todos los estudiantes para modificar -<br />
            </strong>
            <br />
