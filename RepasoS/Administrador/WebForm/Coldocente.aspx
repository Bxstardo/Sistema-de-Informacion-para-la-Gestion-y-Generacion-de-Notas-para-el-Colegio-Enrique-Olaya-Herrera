<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Coldocente.aspx.cs" Inherits="RepasoS.Administrador.WebForm.Coldocente" %>
...
<body bgcolor="#e8e8e8">
    ...
    <div>
        <center>
            ...
            <br />
            <br />
            <asp:Button ID="Button1" runat="server" Text="Consultar" OnClick="Button1_Click" style="height: 26px" />
            <br />
            <br />
                      ...
                      <tr>
                        ...
                        <td style="border: thin groove #800000">
                            <asp:Label ID="Label8" runat="server"></asp:Label>
                                                                                ...
                                                                                <tr>
                        <td style="border: thin groove #800000">Profesion:<br /> </td>
                        <td style="border: thin groove #800000">
                        ...
                        <td style="border: thin groove #800000">
                            <asp:Label ID="Label10" runat="server"></asp:Label>
                                                                                ...
                                                                                <tr>
                        <td style="border: thin groove #800000">Dirige:<br /> </td>
                        <td style="border: thin groove #800000">
                       ...
                       <tr>
                        <td style="border: thin groove #800000">Asignaturas:<br /> </td>
                        <td style="border: thin groove #800000">
            ...
            <br />
            <br />
            <strong>- Ver todos los datos de todos los docentes -</strong><br />
            <br />
            <br />
            <br />
